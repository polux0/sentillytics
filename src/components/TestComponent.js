  ...
  features: [
    {
      ...
      geometry: {
        ...
        coordinates: [
          ...
          [[[-95, 2804], [-52, 2803], [-70, 2740], [-105, 2768], [-95, 2804]]],
          [
            [
              [309, 2961],
              [282, 2924],
          ...
          [[[451, 3022], [412, 3024], [405, 3066], [427, 3066], [451, 3022]]],
          [
            [
              [409, 3016],
              [349, 3004],
    ...
    },
    {
      ...
      geometry: {
        type: "MultiPolygon",
        coordinates: [
          [[[721, 3405], [747, 3411], [763, 3378], [716, 3367], [721, 3405]]],
          [
            [
              [1034, 3682],
              [1021, 3658],
    ...
    },
    {
      ...
      geometry: {
        ...
        coordinates: [
          ...
          [[[-859, 628], [-858, 598], [-890, 594], [-898, 614], [-859, 628]]],
          [
            [
              [-673, 654],
              [-680, 603],
    ...
    },
    {
      ...
      geometry: {
        type: "MultiPolygon",
        coordinates: [
          [[[-750, -73], [-684, -95], [-696, -125], [-764, -80], [-750, -73]]],
          [[[-640, -55], [-674, -75], [-678, -45], [-656, -28], [-640, -55]]],
          [[[-811, -45], [-838, -8], [-821, 17], [-803, -13], [-811, -45]]],
          [
            [
              [-586, -9],
              [-615, 3],
		...
		return(
			...
			<div>
				<div className="graphicon" key='1'>
		  			<h1> Demos </h1>
		  			<br />
		  			<DatePickerExample onStartDateChanges={this.props.onStartDateChanges} onEndDateChanges={this.props.onEndDateChanges} />
		  			<br />
            <SingleDataSet onDataSetChanges={this.props.onDataSetChanges} value={this.props.dataset} /> 
            <br />
            <DropDownSingleSelection onChartTypeChanges={this.props.onChartTypeChanges} value={this.props.chartType}/>
            <br />
            <GroupByFilter onGroupByFilterChanges={this.props.onGroupByFilterChanges} value={this.props.groupBy} />
            <br />
            <br />
            <Chart1 highcharts={Highcharts} options={this.props.options} />
            <br />
            <br />
            <div className="add-project">
              <AddProject onAddProjectHappend={this.props.onAddProjectHappend} glupost="123"/>
            </div>
		  			<br />
		  			<br />
		      </div>
